...
const FALLBACK_DESTINATIONS: Destination[] = [
  { id: "f1", title: "Thác Bản Giốc",    description: "Thác Bản Giốc là một trong những thác nước lớn và đẹp nhất Đông Nam Á, nằm trên sông Quây Sơn giáp biên giới.",                               image_url: "https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=640&q=75&auto=format", sort_order: 1, created_at: "" },
  { id: "f2", title: "Di Tích Pác Bó",   description: "Di tích lịch sử thiêng liêng, nơi Chủ tịch Hồ Chí Minh ở và làm việc, gắn với suối Lê-nin và núi Các-Mác.",                                    image_url: "https://images.unsplash.com/photo-1528127269322-539801943592?w=640&q=75&auto=format",                sort_order: 2, created_at: "" },
